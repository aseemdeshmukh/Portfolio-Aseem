...
const experiences = [
  ...
  },
  {
    ...
    achievements: [
      ...
      "Administered project delivery by interacting with US-based clients for their Web-Design related requirements and provided them support post-delivery by managing plethora of changes through CR process and increased customer satisfaction by 65%",
    ],
