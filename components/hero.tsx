        ...
        <div className="grid md:grid-cols-2 gap-12 items-center mb-12">
          ...
          >
            ...
            <p className="text-xl text-black/80 max-w-md">
              Full Stack Developer specializing in React Native, Spring Boot, and modern web technologies. Passionate
              about creating efficient, secure, and user-friendly applications.
            </p>
